/*
 * File: app/view/InstitucionesWinViewController11.js
 *
...
Ext.define('cartera.view.InstitucionesWinViewController11', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.modasigcamionwin',
    ...
    onbtnGuardarB: function(button, e, eOpts) {
        ...
        if(form.isValid()){
            if(values.id_banco>0){
                ...
                console.log('holaaa' + Ext.getStore('TransporteAlumnoStore').findExact('id_alumno', values.id_alumno));
