...
class PDF extends FPDF
{
    ...
    // Arial bold 15
		...
		$this->Cell($pageWidth-100,10,utf8_decode('SALIDA POR AJUSTES DE AUDITORIA (SOBRANTES)  '),0,0,'L',false);
		$this->Ln(5);	
...
if($sql->num_rows > 0){
	while($r_sql = mysqli_fetch_array($sql)){
		...
		$pdf->Cell($x5,15,rtrim($r_sql['sobrante_exi']," "),0,0,'R',false);
		$pdf->Cell($x5,15,rtrim($r_sql['sobrante_cto']," "),0,0,'R',false);
