...
class CuotasColegiaturaController extends AppController {
    ...
    try{
       ...
       // $intIdNivel = $this->request->query('id_nivel_educativo');
        ...
        //obtiene los ciclos
                ...
                $sQuery="SELECT ci.id_cuota_colegiatura,
                ci.id_institucion,
                ci.id_ciclo_escolar,
                ...
                ELSE ''
                END AS grado,  
                ci.descripcion,UPPER(ne.nombre) AS descrip_nivel, ci.estatus
                    FROM cxcandes.cuotas_colegiaturas AS ci 
        ...
        if (!isset($_POST["grado"])) {
         ...
         $oConexion = $this->getConexion();
           // agrega el registro de la institución.
            $sQuery = "INSERT INTO cuotas_colegiaturas(" .
                      "id_institucion, " .
                      "id_ciclo_escolar, " .
                      "id_nivel_educativo,".
                      "grado,".
    ...
    public function actualiza() 
    {
         ...
         if (!isset($_POST["grado"])) {
            ...
            $oConexion = $this->getConexion();
           // agrega el registro de la institución.
            $sQuery = "UPDATE cuotas_colegiaturas SET descripcion ='".$_POST['descripcion']."',
                       id_nivel_educativo=".$_POST['id_nivel_educativo'].",
                       grado = '".$_POST['grado']."',
                       cuota = ".$_POST['cuota']." 
                         WHERE id_cuota_colegiatura=".$_POST['id_cuota_colegiatura'];
                     // print_r($sQuery);
                     $aResultado = $oConexion->query($sQuery);
                     return $this->asJson(array(
                        "success" => true,
    ...
    public function update() {
       ...
       // echo "CARLOS"; $aRecord["razon_social"]
        ...
        foreach ($aRecords as $aRecord) {
            ...
            $sQuery = "UPDATE cuotas_colegiaturas SET estatus =".$aRecord["estatus"]." WHERE id_cuota_colegiatura =".$aRecord["id_cuota_colegiatura"];
