...
class BancosController extends AppController {
    ...
    try{
        ...
        //obtiene los bancos
        $sQuery = "SELECT id_banco, id_institucion, nombre, afiliacion, num_cta,cta_CLABE,contacto,correo, estatus FROM bancos where id_institucion=".$IdIns;
       // print_r($sQuery);
