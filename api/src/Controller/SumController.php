...
//echo $cond;
        ...
        sum(IF(art.exi_fis<art.existe,art.existe-art.exi_fis,0)) AS sobrante_exi_sum,
        sum(IF(art.cto_fis<art.costo,art.costo-art.cto_fis,0)) AS sobrante_cto_sum,
        sum(IF(art.exi_fis>art.existe,art.exi_fis-art.existe,0)) AS faltante_exi_sum,
        sum(IF(art.cto_fis>art.costo,art.cto_fis-art.costo,0)) AS faltante_cto_sum,
