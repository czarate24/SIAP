...
use Exception;
class FacturacionIngresosController extends AppController {
    ...
    public function read() {
        ...
        $sQuery = "SELECT 
                ...
                cuota.cuota+ cobros.recargo- (ROUND((((IFNULL(becas.porc_actual,0)/100))*cuota.cuota),0))+cobros.descuento  + IFNULL(cuota_trans.cuota,0) AS total,
                forma_pago.forma_pago_id,
                recargo, 
                cuota.cuota + IFNULL(cuota_trans.cuota,0) + IFNULL(cobros.recargo,0) AS cuota,
            ...
            $sQueryConcepto="SELECT id_tipo_servicio, clave_producto, id_unidad_medida,
                ...
                END OR 
                CASE WHEN carnet.id_cuota_transporte>=1
            ...
            // GENERA EL COMPLEMENTO EDUCATIVO PARA LAS FACTURAS
