...
class CobrosCarnetParcialidadController extends AppController {
    ...
    public function read() {
        ...
        $sQuery =  "SELECT referencia, 
                    ...
                    ON ci.id_cuota_inscripcion=descuentos_inscripciones.id_cuota_inscripcion AND MONTH(fecha_fin)=2
