...
class cmbRFCController extends AppController {
 ...
 try{
        ...
        $oConexion = $this->getConexion();
         ...
         $id_alumno = $this->request->query('id_alumno');
      

        //obtiene los bancos
        $sQuery = "SELECT id_dato_facturacion,id_alumno, rfc, razon_social, usoCFDI 
        FROM datos_facturacion as df
        LEFT JOIN sistema_andes.alumnos as alum
        ON alum.id_familia=df.id_familia
        WHERE alum.id_alumno=".$id_alumno;
