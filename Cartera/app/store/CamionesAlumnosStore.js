/*
 * File: app/store/CamionesAlumnosStore.js
 *
...
Ext.define('cartera.store.CamionesAlumnosStore', {
    extend: 'Ext.data.Store',

    requires: [
        'cartera.model.CamionesAlumnosModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            model: 'cartera.model.CamionesAlumnosModel',
            proxy: {
                type: 'ajax',
                api: {
